                ...
                <div class="card-body">
                    <div class="timeline">
                        @foreach($statusTimeline as $index => $step)
                            <div class="timeline-item {{ $index % 2 === 0 ? 'left' : 'right' }} {{ $step['is_completed'] ? 'completed' : '' }} {{ $step['is_current'] ? 'current' : '' }}">
                                <div class="timeline-content">
                                    <div class="d-flex align-items-center mb-2">
                                        <i class="{{ $step['icon'] }} me-2 {{ $step['is_completed'] ? 'text-success' : ($step['is_current'] ? 'text-primary' : 'text-muted') }}"></i>
                                        <h6 class="mb-0 {{ $step['is_completed'] ? 'text-success' : ($step['is_current'] ? 'text-primary' : 'text-muted') }}">
                                            {{ $step['label'] }}
                                        </h6>
                                    </div>
